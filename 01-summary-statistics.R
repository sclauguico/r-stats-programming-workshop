...
sp500 <- read.csv("S&P+500+Stock+closes+2014-2017.csv/S&P 500 Stock closes 2014-2017.csv")
...
# Convert 'year' column to year format in sp500 dataframe
sp500 <- sp500 %>% mutate(year = as.year(year, format = "%d/%m/%Y"))


# Print the upyeard dataframe
print(sp500)


# Create a new column 'year' based on 'year'
sp500 <- sp500 %>% mutate(year = format(year, "%Y"))
