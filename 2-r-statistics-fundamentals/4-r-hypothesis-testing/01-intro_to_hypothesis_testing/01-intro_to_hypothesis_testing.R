...
# Let's begin our analysis by calculating a point estimate (sample statistic), namely the proportion of customer churn.
# 
# customer_churn is available; dplyr is loaded.
# 
...
View(customer_churn)
# 
# Calculate the proportion of customer churn
...
# 
# late_shipments_boot_distn is a bootstrap distribution of the proportion of customer churn. The proportion of customer churn statistic is in the late_prop column.
# 
...
# 
# The null hypothesis, 
# , is that the proportion of customer churn is six percent.
# 
# The alternative hypothesis, 
# , is that the proportion of customer churn is greater than six percent.
# 
# The observed sample statistic, late_prop_samp, the null hypothesis statistic, late_prop_hyp (6%), and the bootstrapstandard error, std_error are available.
